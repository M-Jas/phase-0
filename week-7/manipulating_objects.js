...
//What tests did you have trouble passing? What did you do to make it pass? Why did that work?
  // Add a carson property to the value of the terah children property. Then as an object with the value.
     // It was worded backwards. I did not know I would have to set a property then set it as a object after. Just thought the other way around.
     // It need to be an object then we could add the property and values.

// How difficult was it to add and delete properties outside of the object itself? Not bad just needed to know the order it was placed

// What did you learn about manipulating objects in this challenge? It is easier to do outside, I think.
  // you have as much power outside as inside. It reminded me of ruby classes.
