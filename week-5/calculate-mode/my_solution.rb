...
#first trial___________________________________________________
# def mode(array)
#   # temp = 0
#   curr_hig = 0
#   array.each do |item|
...
def mode(array)
  array.each_with_object(Hash.new(0)){|numbers, item| numbers[item] += 1}
  biggest_array = numbers.values.sort!.last
  numbers.delete_if {|key, value| value < biggest_array}
  end

#I having and issue with condesing the code. This passes almost all of the test.




# 4. Reflection_______________________________________________